...
**Step 2: Kill any remaining processes on ports 8001 and 3000**
```powershell
...
**Step 3: Verify**
Confirm that ports 8001 and 3000 are free and Docker containers are stopped (unless -KeepInfra). Report the results.
